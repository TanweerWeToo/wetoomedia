...
const Hero = () => {
  ...
  return (
    <section className="bg-primary text-text font-sans">
      <div className="max-w-screen-xl mx-auto px-4 py-20 gap-12 text-white/90 md:px-8 flex flex-col">
        <div className="space-y-5 max-w-3xl mx-auto text-center">
          <div className="flex flex-wrap items-center justify-center gap-6">
            {features.map((item, idx) => (
              <div
                key={idx}
                className="flex items-center gap-x-2 text-sm sm:text-lg"
              >
                {item.icon}
                {item.name}
              </div>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
            Explore in-demand <span className="text-secondary">careers</span>{" "}
